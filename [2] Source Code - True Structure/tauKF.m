% Source Credit: https://github.com/sorooshafiee/WKF
% Source Credit: https://mathworks.com/matlabcentral/fileexchange/54308-robust-kalman-filtering-package?focused=5751770&tab=function
% Original file name: "rkalman.m"
...
function [x, G, V, P, th] = tauKF(sys, c, tau, y, x_0, V_0)
    ...
    %% This section added by Shixiong Wang
    %{{ 
        [a,b] = size(sys.H);
        A = sys.F;
        B = [sys.G*sys.Q*(sys.G)' zeros(b,a)];
        C = sys.H;
        D = [zeros(a,b) sys.D*sys.R*(sys.D)'];
    %}}
